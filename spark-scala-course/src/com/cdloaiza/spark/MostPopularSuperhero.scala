...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val totalFriendsByCharacterSorted = flipped.sortByKey(false)
    
    val topMostPopular = totalFriendsByCharacterSorted.take(10)
    
    topMostPopular.foreach(x => println((namesRdd.lookup(x._2)(0),x._1)))
